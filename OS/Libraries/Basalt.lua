...
aa["objects"]["List"]=function(...)local ab=da("Object")
local bb=da("utils")local cb=bb.getValueFromXML
return
function(db)local _c=ab(db)local ac="List"_c.width=16;_c.height=6
_c:setZIndex(5)local bc={}local cc;local dc;local _d=true;local ad="left"local bd=0;local cd=true
local dd={getType=function(__a)return ac end,addItem=function(__a,a_a,b_a,c_a,...)
table.insert(bc,{text=a_a,bgCol=
b_a or __a.bgColor,fgCol=c_a or __a.fgColor,args={...}})if(#bc<=1)then __a:setValue(bc[1],false)end
...
return{loadNFP=_c,loadBIMG=ac,loadImage=dc,resizeBIMG=ad,loadImageAsBimg=_d}end;return aa["main"]()